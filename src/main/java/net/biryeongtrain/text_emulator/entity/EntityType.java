...
public class EntityType {
    public static Codec<EntityType> CODEC = Codec.lazyInitialized(() -> RecordCodecBuilder.create(instance -> instance.group(
            ...
            EntityTag.CODEC.listOf().fieldOf("tags").forGetter(EntityType::getTags)
    ...
    private EntityType(RegistryKey<EntityType> key, float defaultHealth, float defaultDamage, float defaultArmor, LootTableManager lootTableManager, List<EntityTag> tags) {
        this.key = key;
